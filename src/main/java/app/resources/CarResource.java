...
public interface CarResource {
	...
	@Operation(summary = "Get all cars", description = "Retrieves all the cars from the DB", responses = {
			@ApiResponse(description = "Cars", responseCode = "200", content = @Content(array = @ArraySchema(schema = @Schema(implementation = CarDTO.class)))), })
	...
	@Operation(summary = "Add new car", description = "Add a new car to the DB", responses = {
			@ApiResponse(description = "Created", responseCode = "201", content = @Content(array = @ArraySchema(schema = @Schema(implementation = CarDTO.class)))), })
	...
	@Operation(summary = "Get car filtering by ID", description = "Retrieves a car filtered by ID from the DB", responses = {
			@ApiResponse(description = "Car", responseCode = "200", content = @Content(array = @ArraySchema(schema = @Schema(implementation = CarDTO.class)))), })
	...
	@Operation(summary = "Delete a car filtering by ID", description = "Delete a car filtered by ID from the DB", responses = {
			@ApiResponse(description = "No content", responseCode = "204", content = @Content(array = @ArraySchema(schema = @Schema(implementation = CarDTO.class)))), })
